    ...
    try:
        ...
        for _ in range(n_repeats_cv2):
            ...
            for train_idx, test_idx in outer_cv.split(X):
                ...
                # Inner CV
                best_n_components = n_components_range[0]  # Default use first value
                best_score = -np.inf
                ...
                for n_comp in n_components_range:
                    ...
                    # Use validation set AUC to select best component number
        ...
        return test_predictions, test_true, feature_importance, avg_inner_cv_performance
